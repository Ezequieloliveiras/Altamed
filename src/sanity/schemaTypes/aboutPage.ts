...
export const aboutPage = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      description: "Use uma linha em branco para separar parágrafos.",
      type: "text",
      rows: 8,
      group: "institution",
    }),
        ...
        defineArrayMember({
          ...
          preview: {
            ...
            prepare: ({ title, media, order }) => ({
              ...
              media,
              subtitle:
                typeof order === "number" ? `Ordem ${order}` : undefined,
            }),
          },
        }),
      ],
    ...
    defineField({
      name: "stats",
      title: "Indicadores",
      description: "A seção só aparece quando houver ao menos um item.",
      type: "array",
      group: "closing",
      of: [
        defineArrayMember({
          ...
          fields: [
            ...
            defineField({
              name: "value",
              title: "Valor",
              description: "Use somente números. Exemplo: 500.",
              type: "number",
            ...
            defineField({
              name: "suffix",
              title: "Sufixo",
              description: 'Exemplo: " anos".',
              type: "string",
            }),
            defineField({
              name: "title",
              title: "Título",
              description: 'Exemplo: "clientes atendidos".',
              type: "string",
              validation: (Rule) => Rule.required(),
            }),
            defineField({
          ...
          preview: {
            select: { prefix: "prefix", value: "value", title: "title" },
            prepare: ({ prefix, value, title }) => ({
              title: `${prefix || ""}${typeof value === "number" ? value.toLocaleString("pt-BR") : ""}`,
              subtitle: title,
            }),
          },
        }),
  ...
  preview: {
    prepare: () => ({
      title: "Quem Somos",
      subtitle: "Conteúdo da página institucional",
    }),
  },
});
